IInfraredFrameSource::get\_IsActive Method  
==========================================  

InfraredフレームのSourceの動作状況を取得する。 <span id="syntaxSection"></span>
...
*isActive*    
Type: BOOLEAN  
[out] InfraredフレームのSourceが動作している場合は**true**、動作していない場合は**false**。  
